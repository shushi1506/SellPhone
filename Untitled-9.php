...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <?php require_once( 'E:\Programs\xampp\htdocs\Sell_Phone\php\connectpt.php'); 
...
{ 
$list_page .= "<td><a href='Untitled.php?page={$i}'> &nbsp;{$i}&nbsp; </a></td>"; 
} 
} 
} 
               ...
               <div id="left_content">
               		<div class="left_menu">
               		  <h3>Hãng Sản Xuất</h3>
                   		...
                   		<p>
                            <?php if ($id==1){?><a href="/Sell_Phone/index.php?id=1&&idgia=<?php echo $idgia;?>" class="label1"><span>Sam Sung</span></a><?php }else{   ?>
                          <a href="/Sell_Phone/index.php?id=1&&idgia=<?php echo $idgia;?>">  <label >Sam Sung</label></a>
						<?php }?>
               		 </p>
                       <p>
  						  <?php if ($id==2){?><a href="/Sell_Phone/index.php?id=2&&idgia=<?php echo $idgia;?>" class="label1"><span>Iphone</span></a><?php }else{   ?>
                       <a href="/Sell_Phone/index.php?id=2&&idgia=<?php echo $idgia;?>">  <label >Iphone</label></a>
       					<?php }?>
                        </p>	
               		  ...
               		  <p>
                              ...
                              <a href="/Sell_Phone/index.php?id=3&&idgia=<?php echo $idgia; ?>">  <label >Sky</label></a>
               		    <?php }?>
               		    ...
               		    <p>
               		        ...
               		        <?php if ($id==4){?><a href="/Sell_Phone/index.php?id=4&&idgia=<?php echo $idgia;?>" class="label1"><span>Nokia</span></a><?php }else{   ?>
                         <a href="/Sell_Phone/index.php?id=4&&idgia=<?php echo $idgia; ?>"> <label >Nokia</label></a>
               		      <?php }?>
                           </p>
                           <p>
                          
               		       <?php if ($id==5){?><a href="/Sell_Phone/index.php?id=5&&idgia=<?php echo $idgia;?>" class="label1"><span>LG</span></a><?php }else{   ?>
                          <a href="/Sell_Phone/index.php?id=5&&idgia=<?php echo $idgia; ?>"> <label >LG      </label></a>
               		    <?php }?>
  </p>
               		    <p>
                        <?php if ($id==6){?><a href="/Sell_Phone/index.php?id=6&&idgia=<?php echo $idgia;?>" class="label1"><span>OPPO</span></a><?php }else{   ?>
               		        <a href="/Sell_Phone/index.php?id=6&&idgia=<?php echo $idgia; ?>"><label >OPPO</label></a>
							<?php }?>
</p>
               		    <p>
               		       <?php if ($id==7){?><a href="/Sell_Phone/index.php?id=7&&idgia=<?php echo $idgia;?>" class="label1"><span>Sam Sung</span></a><?php }else{   ?>
                          <a href="/Sell_Phone/index.php?id=7&&idgia=<?php echo $idgia; ?>"> <label > HTC</label></a>
               		   <?php }?>
                        </p>
               		    <p>
                         <?php if ($id==8){?><a href="/Sell_Phone/index.php?id=8&&idgia=<?php echo $idgia;?>" class="label1"><span>Sony</span></a><?php }else{   ?>
                            <a href="/Sell_Phone/index.php?id=8&&idgia=<?php echo $idgia; ?>"><label >Sony</label></a>
           		       <?php }?>
                        </p>
                       <p>
                          <?php if ($id==0){?><a href="/Sell_Phone/index.php?id=0&&idgia=<?php echo $idgia;?>" class="label1"><span>Tất Cả</span></a><?php }else{   ?>
                            <a href="/Sell_Phone/index.php?id=0&&idgia=<?php echo $idgia; ?>" ><label>Tất Cả</label></a>
           		       <?php }?>
                        </p>     
...
?>
                  ...
                  <?php $result1 = mysql_query($sql1, $conn) or die(mysql_error($conn)); 
				...
				?>
                           ...
                           <a href="/Sell_Phone/Buy_product.php?id=<?php echo $row1['MaPhone']; ?>" class="buy">Mua</a>
                           <figure class="info">
